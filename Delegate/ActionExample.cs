...
public class ActionExample
{
    ...
    {
        Action simpleAction = () => Console.WriteLine("Hello World!!!"); //используем тип делегата Action, не объявляя его, т.к. он предустановлен
        simpleAction();
        
        // Action<in T1, in T2, ... in T16> - 16 параметров
