...
public class Lambda
{
    ...
    public void Example0()
    {
        ...
        string WordLambda() => "word"; // сокращение записи. Лямбда-выражение является делегатом.
    ...
    public void Example2()
    {
        ...
        var sum1 = (int x, int y) =>
            Console.WriteLine(
                $"{x} + {y} = {x + y}"); //если неявная типизация, то нужно указывать тип параметров, а не (x, y)
        sum1(1, 2);
    ...
    public void Example4()
    {
        ...
        var message = () => Console.WriteLine("MTS");
