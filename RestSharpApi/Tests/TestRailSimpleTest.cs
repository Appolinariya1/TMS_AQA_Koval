...
public class TestRailSimpleTest
{
    ...
    public void SimplePostTest()
    {
        ...
        json.Add("name", "WP Project 2"); //первый тест только с обяз. полями, второй со всеми полями 
        ...
        var request = new RestRequest(endpoint)
            .AddJsonBody(JsonSerializer.Serialize(json)); //только сериализатор из System может работать с dictionary
        /*
         * Content-Type
