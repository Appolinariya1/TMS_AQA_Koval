...
public class SingleItem
{
    ...
    public void RunMethodSyntax()
    {
        ...
        //var queryResult2 = _testIntSet.First(num => num == 12); // Exception - лучше сначала проверить, есть ли элемент в принципе, а потом уже брать первый
        ...
        // Single - является ли условие единственным (только 1 значение из этой коллекции может вернуть true для этого условия)
